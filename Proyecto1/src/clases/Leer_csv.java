    ...
    public void leer_archivoInvestigadores(String csv){
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if(contador !=0){ //Condición para que el programa no lea la primera fila de encabezados
    ...
    public void leer_cargaMuestra(String csv, int estado){
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if(incremento != 0){ //Condición para que el programa no lea la primera fila de encabezados
